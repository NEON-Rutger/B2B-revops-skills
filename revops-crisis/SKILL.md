...
description: >
  ...
  missed for multiple quarters, win rate collapsing, pipeline coverage below 3x
  and falling, NRR crashed below 90%, multiple simultaneous system failures,
  loss of trust between functions, data that can't be trusted, or scenarios like
  "everything is broken," "forecast is ±30% wrong," "we're losing deals we should
  win," "I can't trust our data," "sales blames marketing blames product," "three
  ...
  "where do we even start," or "we're in firefighting mode." BOUNDARY: This is
