...
description: >
  ...
  'post-mortem this deal,' 'buyer interview,' 'our CRM loss reasons are
  useless,' 'competitive losses,' 'what is actually killing our deals,' or
  any situation where decisions about positioning, product, or process are
  ...
  consume the competitive findings. deal-qualification-gates consumes the
  findings upstream: recurring loss causes become new evidence-gate floors.
status: stable
---
...
A win-loss program replaces attribution folklore with two evidence lanes, run on a standing cadence.
...
- **Timing:** 2-6 weeks after the decision. Sooner is raw; later is revisionist.
